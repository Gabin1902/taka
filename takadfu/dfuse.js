...
(function() {
    ...
    dfuse.Device.prototype.do_download = async function(xfer_size, data) {
        if (!this.memoryInfo || ! this.memoryInfo.segments) {
            throw "No memory map available";
        }

        this.logInfo("1... Erasing DFU device memory");
        ...
        this.logInfo("2... Copying firmware to DFU device");
