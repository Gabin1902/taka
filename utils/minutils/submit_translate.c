...
uint8_t APDU_SELECT_AID[] = {
    0x00, 0xA4, 0x04, 0x04, 0x0E, 0xE8, 0x28, 0xBD,
...
void pts_translate(struct pts_s *pts, size_t count, int offx, int offy)
{
  int i;
                               ...
                               int mincount, unsigned char **out, int *outlen)
{
    ...
    pts_translate(pts, pts_count, offx, offy);
...
int main(int argc, char **argv)
{
    ...
    // for (num=3; num<55; num++) {
    num = 25;
    // for (off=-20; off<50; off+=5) {
    for (off=-75; off<75; off+=5) {
